<?php
  ...
  if ($_SESSION['isInstructor']) {
    $query = $dbcon->prepare("SELECT rl.roundlevelid, rl.numofq, rl.maxptsperq, rl.goalpts, rl.goalcompleteround, rl.goalbeatopponent, rl.game_gameid, g.users_c_number
