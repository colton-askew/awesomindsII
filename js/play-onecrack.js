...
var playStateOC = Object.create(playState);

playStateOC.timesAnswered = 0;

playStateOC.btnClick = function(){
...
playStateOC.updateScores = function(answerCorrect, didntAnswer){
...
playStateOC.createTimer = function(){}; //emptied to remove timer visuals

playStateOC.updateTimer = function(){}; //emptied; not using this timer in this mode

playStateOC.update = function(){ //animates scores and keeps score text and names positioned near their respective avatars
...
playStateOC.showAnswers = function(fromButton) { //show AI's selected answers
