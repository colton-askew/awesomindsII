  ...
  create: function(){
    ...
    var modes = [
     ...
     // { name: 'Time Bonus', desc: 'The faster you respond, the more points you get', prestate: 'pregameTB', gamestate: 'playTB', id: 1, endstate: 'endOfGameTB', maxPtsPerQ: 25, totalTime: 10},
      { name: 'One Crack', desc: 'You only get one choice\n 15 points if you are correct', prestate: 'pregameOC', gamestate: 'playOC', id: 1, endstate: 'endOfGameOC', maxPtsPerQ: 15, totalTime: 25},
      { name: 'Big Money', desc: 'Keep choosing until you get the right answer', prestate: 'pregameBM', gamestate: 'playBM', id: 2, endstate: 'endOfGameBM', maxPtsPerQ: 100, totalTime: 25},
      { name: 'Choose 1, 2, or 3', desc: 'Choose up to 3 of the options displayed', prestate: 'pregameC123', gamestate: 'playC123', id: 3, endstate: 'endOfGameC123', maxPtsPerQ: 15, totalTime: 25},
      { name: 'Keep Choosing', desc: 'Keep selecting options until you find the right one.\n(Best for beginners)', prestate: 'pregameKC', gamestate: 'playKC', id: 4, endstate: 'endOfGameKC', maxPtsPerQ: 15, totalTime: 25},
