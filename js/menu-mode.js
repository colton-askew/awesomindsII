var menuModeState = {
  create: function(){
    ...
    var modes = [
      { name: 'Keep Choosing', desc: 'Keep selecting options until you find the right one.\n(Best for beginners)', prestate: 'pregameKC', gamestate: 'playKC', id: 0, endstate: 'endOfGameKC', maxPtsPerQ: 15, totalTime: 25},
      { name: 'Countdown Crown', desc: 'The faster you respond, the more points you get', prestate: 'pregame', gamestate: 'play', id: 1, endstate: 'endOfGame', maxPtsPerQ: 25, totalTime: 25}, 
